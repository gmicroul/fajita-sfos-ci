...
files["drivers/media/platform/msm/camera/cam_cdm/cam_cdm.h"]="${REPO_BASE}/drivers/media/platform/msm/camera/cam_cdm/cam_cdm.h"
files["drivers/media/platform/msm/camera_oneplus/cam_cdm/cam_cdm.h"]="${REPO_BASE}/drivers/media/platform/msm/camera/cam_cdm/cam_cdm.h"
...
files["drivers/media/platform/msm/camera/cam_hw_intf.h"]="${REPO_BASE}/drivers/media/platform/msm/camera/cam_hw_intf.h"
files["drivers/media/platform/msm/camera_oneplus/cam_hw_intf.h"]="${REPO_BASE}/drivers/media/platform/msm/camera/cam_hw_intf.h"
