...
# 创建trace/events目录 (根据mdss_pll_trace.h中的TRACE_INCLUDE_PATH .)
mkdir -p "$KERNEL_DIR/drivers/clk/qcom/mdss/trace/events"

# 创建空的mdss_pll.h文件
echo "创建空的mdss_pll.h文件..."
cat > "$KERNEL_DIR/drivers/clk/qcom/mdss/trace/events/mdss_pll.h" << 'EOF'
...
echo "=========================================="
echo ""
echo "已创建空的mdss_pll.h文件 (位于: drivers/clk/qcom/mdss/trace/events/)"
